...
const REVEAL_CONTENT = [
  {
    upper: ["nome: Eduardo Severo de Souza", "Idade:16", "Sou Programador Back-End, Um pouco de Front-End.", "Designer Gráfico, Modelador 3D, Artista VFX."],
    lower: "Aos poucos evoluindo.",
  },
  {
    upper: [
      "Amante de Basquete e jogos do estilo Soulslike.",
      "Realmente não curto muito colocar coisa aqui.",
      "Boa parte do tempo estou dormindo ou jogando.",
    ],
    lower: "Não importa muito isso.",
  },
  {
    upper: [
      "Busco mais oportunidades pra ter mais experiência e crescer profissionalmente.",
      "Ainda estou aprendendo e procuro aprimorar meu trabalho cada vez mais.",
      "Um resumo total, eu só quero mais dinheiro.",
    ],
    lower: "Sim, é só isso.",
  },
];
...
const ITEMS = [
  {
    id: "twitch", label: "SOBRE MIM", handle: "@otaldotherealsevero", href: "https://www.twitch.tv/otaldotherealsevero", icon: "🎮", barIcon: icon1, bars: 1, newBars: [0], counts: ["0"],
    links: ["https://www.twitch.tv/otaldotherealsevero"],
    stats: [
      { tag: "FOL", value: "0", color: "#9147ff" },
      { tag: "VWR", value: "0",  color: "#bf94ff" },
    ],
  },
  {id: "instagram", label: "FATOS SOBRE MIM", handle: "@holysevero", href: "https://www.instagram.com/holysevero/", icon: "📷", barIcon: icon2, bars: 5, newBars: [1, 2], counts: ["0", "0", "0", "0", "0"],
    links: ["https://www.instagram.com/holysevero/", "https://www.instagram.com/holysevero/", "https://www.instagram.com/holysevero/", "https://www.instagram.com/holysevero/", "https://www.instagram.com/holysevero/"],
    stats: [
      { tag: "FOL", value: "0", color: "#e1306c" },
      { tag: "PST", value: "0",  color: "#f77737" },
    ],
  },
  {
    id: "tiktok", label: "OUTRAS COISAS", handle: "@justsevero", href: "https://www.tiktok.com/@justsevero", icon: "🎵", barIcon: icon3, bars: 7, newBars: [0, 3, 5, 6], counts: ["0", "0", "0", "0", "0", "0", "0"],
    links: ["https://www.tiktok.com/@justsevero", "https://www.tiktok.com/@justsevero", "https://www.tiktok.com/@justsevero", "https://www.tiktok.com/@justsevero", "https://www.tiktok.com/@justsevero", "https://www.tiktok.com/@justsevero", "https://www.tiktok.com/@justsevero"],
    stats: [
