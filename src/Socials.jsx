...
const ITEMS = [
  {
    id: "twitch", label: "TWITCH", handle: "@otaldotherealsevero", href: "https://www.twitch.tv/otaldotherealsevero", icon: "🎮", barIcon: icon1, bars: 1, newBars: [0], counts: ["0"],
  ...
  {
    id: "instagram", label: "INSTAGRAM", handle: "@holysevero", href: "https://www.instagram.com/holysevero/", icon: "📷", barIcon: icon2, bars: 5, newBars: [1, 2], counts: ["0", "0", "0", "0", "0"],
  ...
  {
    id: "tiktok", label: "TIKTOK", handle: "@justsevero", href: "https://www.tiktok.com/@justsevero", icon: "🎵", barIcon: icon3, bars: 7, newBars: [0, 3, 5, 6], counts: ["0", "0", "0", "0", "0", "0", "0"],
